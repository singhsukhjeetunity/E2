...
EMA receives **40%** of the selected **20:40:40 Gold / EMA / Compression** risk budget. At 2% total, set `InpEMACashRisk` to **800 on a 100,000 starting balance** (0.8% per trade). Source defaults are unchanged. See [portfolio allocation](STRATEGY_REFERENCE.md#selected-portfolio-allocation).
