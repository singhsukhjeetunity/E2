...
}m_diag.expected_fields=(london_record?28:20);m_diag.rows_read=1;if(fields!=m_diag.expected_fields){m_diag.recovery_failure_reason="STATE_ROW_PARSE_FAILED";return(false);}m_diag.valid_rows_parsed=1;return(true);}
public:
